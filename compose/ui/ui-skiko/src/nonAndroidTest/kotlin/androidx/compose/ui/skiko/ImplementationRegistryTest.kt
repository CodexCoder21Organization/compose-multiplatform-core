...
import androidx.compose.ui.graphics.SkikoGraphicsImpl
...
import androidx.compose.ui.text.SkikoTextImpl
...
class ImplementationRegistryTest {
    ...
    fun graphicsImplementationRejectsDifferentReplacement() {
        PlatformTextRegistry.clear()
        PlatformGraphicsRegistry.clear()
        PlatformGraphicsRegistry.register(SkikoGraphicsImpl)

        val error = assertFailsWith<IllegalStateException> {
            PlatformGraphicsRegistry.register(
                object : PlatformGraphics by SkikoGraphicsImpl {}
            )
        }
    ...
    fun textImplementationRejectsDifferentReplacement() {
        PlatformGraphicsRegistry.clear()
        PlatformTextRegistry.clear()
        PlatformTextRegistry.register(SkikoTextImpl)

        val error = assertFailsWith<IllegalStateException> {
            PlatformTextRegistry.register(
                object : PlatformText by SkikoTextImpl {}
            )
        }
