...
/**
 * Skiko-side text implementation entry point. Registration is intentionally left to a follow-up
 * integration change.
 */
@OptIn(InternalComposeUiApi::class)
internal object SkikoTextImpl : PlatformText {
    ...
    ): PlatformParagraph = PlatformParagraphImpl(
